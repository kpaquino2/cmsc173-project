                        ...
                        ? `${
                              typeof window !== undefined
                                  ? window.innerHeight / 2 -
                                    setNodeRef.current?.clientHeight
                                  : 0
                          }`
                        : undefined,
                        ...
                        <FontAwesomeIcon
                            ...
                            onClick={(e) => {
                                ...
                                setIsDayEnabledSubject({
                                    ...
                                    Wednesday:
                                        subjects[index].daysOccur.Wednesday,
                                    Thursday:
                                        subjects[index].daysOccur.Thursday,
                                    Friday: subjects[index].daysOccur.Friday,
                                    Saturday:
                                        subjects[index].daysOccur.Saturday,
                                });
                            }}
                        />
                        <FontAwesomeIcon
                            ...
                            onClick={(e) => {
                                ...
                                if (
                                    newSubjects[index].labSections.length !== 0
                                ) {
                                    for (let i in newSubjects.labSections) {
                                        ...
                                        deleteClass(tbd);
                                        newSubjects[index].labSections.splice(
                                            i,
                                            1
                                        );
                                    }
